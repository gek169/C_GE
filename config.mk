...
CFLAGS= -Wall -Ofast -std=c99 -DNDEBUG -fopenmp -march=native
#CFLAGS= -Wall -Ofast -std=c99 -DNDEBUG -march=native
CFLAGS_LIB= -Wall -Ofast -std=c99 -pedantic -DNDEBUG -fopenmp -march=native
#CFLAGS_LIB= -Wall -Ofast -std=c99 -pedantic -DNDEBUG -march=native
